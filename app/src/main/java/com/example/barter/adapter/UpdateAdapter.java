...
import com.example.barter.home.ui.users.UpdateActivity;
...
public class UpdateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public UpdateAdapter(Context context, Activity mActivity, ArrayList<Product> userList){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        viewHolder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product_category",userList.get(position).getProduct_category());
