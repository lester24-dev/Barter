...
public class Product {
    String product_name, product_category, product_color, product_des, product_image, product_brand, product_size, product_year, product_seller, product_price, product_address, hash;
